        ...
        >
          {
            ...
            <div key={iKey} className="max-w-sm bg-white border m-3 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-md hover:shadow-black">
                <a>
                    <img className="rounded-t-lg" src={aData.images.webp.large_image_url} alt="" />
                </a>
                <div className="p-5" title={aData.title}>
                    ...
                    <a href={aData.trailer.url} target="_blank" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Watch Trailer
